...
# Todo: Выяснить что должно происходить раньше нагрев до 95 или прокачка
...
# TODO: проверить время задержки и количество итераций
for i in range(3):
    print("Итерация №" + str(i + 1))
...
SetThermalCyclerTempLowSpeed(startTemp=65, stopTemp=40, timeToGo=250)
...
time.sleep(15)
print("Встраивание первого нуклеотида")
PumpToFlowcell(actPos=1, volume=180, aspirationRate=72, dispenseRate=2000)
time.sleep(60)
print("Выход на температуру 65°C")
SetThermalCyclerTemp(temp=65)
print("Ожидание 90 секунд")
time.sleep(90)
print("Промывка буфером")
PumpToFlowcell(actPos=3, volume=36, aspirationRate=72, dispenseRate=2000)
time.sleep(15)
...
PumpToFlowcell(actPos=2, volume=180, aspirationRate=72, dispenseRate=2000)
time.sleep(30)
print("Промывка буфером")
PumpToFlowcell(actPos=3, volume=90, aspirationRate=72, dispenseRate=2000)
time.sleep(15)
