...
time.sleep(120)
PumpToFlowcell(actPos=11, volume=743)
PumpToFlowcell(actPos=11, volume=203, aspirationRate=9)
SetThermalCyclerTemp(temp=38)
time.sleep(300)
PumpToFlowcell(actPos=3, volume=311)
SetThermalCyclerTemp(temp=50)
for i in range(8):
    PumpToFlowcell(actPos=8, volume=90, aspirationRate=9)
    PumpToFlowcell(actPos=7, volume=90, aspirationRate=9)
    PumpToFlowcell(actPos=6, volume=196, aspirationRate=9)
    time.sleep(15)
PumpToFlowcell(actPos=3, volume=311)
SetThermalCyclerTemp(20)
time.sleep(45)
PumpToFlowcell(actPos=10, volume=743)
PumpToFlowcell(actPos=10, volume=203, aspirationRate=9)
SetThermalCyclerTemp(38)
time.sleep(300)
PumpToFlowcell(actPos=3, volume=311)
PumpToFlowcell(actPos=8, volume=196, aspirationRate=9)
SetThermalCyclerTemp(temp=65)
time.sleep(60)
PumpToFlowcell(actPos=14, volume=743)
PumpToFlowcell(actPos=14, volume=203, aspirationRate=9)
SetThermalCyclerTemp(temp=40)
time.sleep(60)
PumpToFlowcell(actPos=3, volume=311)
# Second Base
